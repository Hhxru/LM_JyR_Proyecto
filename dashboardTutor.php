...
<body>
    ...
    <section id="cuerpoPrincipal">
        ...
        <article id="tabla">
            ...
            <form action="dashboardTutor.php" method="post">
                    <input type="text" class="textbox" name="buscar" value="<?php print($buscar)?>" placeholder='Busqueda por nombre'>
            ...
            <table>
                ...
                <?php
                    ...
                    while($row=$stmt->fetch()){
                        ...
                        $buscEmpresa = "<button class=button onclick=window.location='asignarPractica.php?id=".$row['email']."'>Buscar Empresa</button>";

                        $gestEmpresa = "<button class=button onclick=window.location='gestionarPractica.php?id=".$row['email']."'>Gestionar Practica</button>";
